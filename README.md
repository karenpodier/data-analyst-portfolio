...
| Power BI | Retail Sales Performance Analysis | Built a Power BI report to help senior management monitor sales performance, profitability, regional trends, product performance and discount impact. | Complete | [View Project](https://github.com/karenpodier/retail-sales-performance-powerbi) |
...
| Python / EDA | Insurance Charges Python Analysis | Analysed medical insurance charges using Python to explore the impact of age, BMI, smoking status and demographic factors. | Complete | [View Project](https://github.com/karenpodier/insurance-charges-python-analysis) |
